...
class Info extends Model
{
    ...
    protected $fillable = [
        ...
        'iac_b', 'saa_b', 'tec_b', 'ftg_b', 'tga_b', 'sta_b', 'pa_b', 'eca_b','ecl_b','ss_b',
        'iac_s', 'saa_s', 'tec_s', 'ftg_s', 'tga_s', 'sta_s', 'pa_s', 'eca_s','ecl_s','ss_s',
        'iac_p', 'saa_p', 'tec_p', 'ftg_p', 'tga_p', 'sta_p', 'pa_p', 'eca_p','ecl_p','ss_p',
        'iac_g', 'saa_g', 'tec_g', 'ftg_g', 'tga_g', 'sta_g', 'pa_g', 'eca_g','ecl_g','ss_g',
