        ...
        <div class="px-4 py-4 mx-auto">
            ...
            <div class="grid gap-1 md:grid-flow-col">
                ...
                <div
                    ...
                    <p class="font-light text-gray-500 dark:text-gray-400">{{ __('form.bp_t1') }}</p>
                ...
                <div
                    ...
                    <p class="font-light text-gray-500 dark:text-gray-400">{{ __('form.sp_t1') }}</p>
                    <div class="flex flex-row gap-2 mx-auto text-left">
                        <div class="mr-4 text-3xl font-extrabold text-black dark:text-white"
                ...
                <div
                    ...
                    <p class="font-light text-gray-500 dark:text-gray-400">{{ __('form.pp_t1') }}</p>
                    <div class="flex flex-row gap-2 mx-auto">
                        <div class="mr-4 text-3xl font-extrabold text-black dark:text-white"
                            x-text="month? '$'+ppma:'$'+ppya"></div>
                        <div class="flex flex-col">
                            <div class="text-xs text-left text-gray-500 dark:text-gray-400">{{ __('form.per') }}</div>
                            <div class="text-xs text-left text-gray-500 dark:text-gray-400">{{ __('form.mo') }}</div>
                        </div>
                    </div>
                    <a target="_blank"
                        x-bind:href="month ?
