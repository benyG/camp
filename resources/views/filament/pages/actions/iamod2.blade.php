...
src='{{ asset('img/'.(auth()->user()->vo2? 'Becky':'Ben').'.webp') }}' class="mx-auto rounded-full ring-custom-600 dark:ring-custom-400 ring-2" />
<p class="mt-2 text-sm text-center text-gray-500 fi-modal-description dark:text-gray-400">
    {{__('email.hello')}} {{ explode(' ',auth()->user()->name)[0]}}, {{__('main.i1')}}: <br><br>
</p>
