...
<div onmousedown="return false" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off
        ...
        class='grid bg-white divide-y divide-gray-200 shadow-sm fi-fo-wizard-header md:grid-flow-col md:divide-y-0 dark:divide-white/5 rounded-xl ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10',
            ...
            <li class="relative flex fi-fo-wizard-header-step">
                <button
                    ...
                    @if ($qcur2<$qtot)
                    <div class="flex items-center justify-center w-10 h-10 rounded-full fi-fo-wizard-header-step-icon-ctn bg-primary-600 dark:bg-primary-500 shrink-0">
                        <x-filament::icon
                    ...
                    <div class="grid justify-items-start">
                            ...
                            <span class="text-sm text-gray-500 fi-fo-wizard-header-step-description text-start dark:text-gray-400">
            ...
            <li class="relative flex fi-fo-wizard-header-step">
                ...
                >
                    ...
                    <div class="grid justify-items-start">
                            ...
                            <span class="text-sm font-bold text-gray-500 fi-fo-wizard-header-step-description text-start dark:text-gray-400">
                                {{($qtot-$qcur)}} / {{($qtot)}}
                            </span>
                    </div>
                </button>
            ...
            <li class="relative flex fi-fo-wizard-header-step">
                <button
                    ...
                    <div class="grid justify-items-start">
                            <span class="text-sm font-medium fi-fo-wizard-header-step-label text-primary-500 dark:text-primary-400">
                               Timer (minutes left)
                            </span>
                            @if ($record->type=='0')
                            <span class="text-sm font-bold text-gray-500 fi-fo-wizard-header-step-description text-start dark:text-gray-400">Unlimited</span>
                            @else
                            <span x-data="timer({{$tim}})" x-init="init();setTimeout(() => { $wire.closeComp() }, {{$tim}}*60000);" :class=" parseInt(time().minutes)<5 ? 'text-danger-500 dark:text-danger-400' : 'text-gray-500 dark:text-gray-400'" class="text-sm font-bold fi-fo-wizard-header-step-description text-start">
   ...
   <div class="p-6 outline-none fi-fo-wizard-step">
        ...
        <span style='--c-50:var(--danger-50);--c-400:var(--danger-400);--c-600:var(--danger-600);' class="text-xs text-custom-600">@error('ans'){{ $message }}@enderror</span>
         {!! $cans !!}
