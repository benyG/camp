        ...
        <div class="flex items-center gap-x-2">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs italic text-gray-500 dark:text-gray-400">
                    {{ __('main.si') }}
                    {{ \Illuminate\Support\Carbon::parse($user->created_at)->locale('fr')->isoFormat('llll') }}
                </p>
            ...
            <div class="flex flex-col gap-y-2">
                <div class="flex flex-row items-center gap-x-2">
                    <h2 class="text-xs font-semibold text-gray-950 dark:text-white">
                        {{ __('main.rk') }}</h2><span {!! match ($user->ex) {
                            0 => "style='--c-50:var(--warning-50);--c-400:var(--warning-400);--c-600:var(--warning-600);'",
                        ...
                        {{ match ($user->ex) {0 => 'S. Admin',1 => 'Admin',2 => 'Free',3 => 'Basic',4 => 'Standard',5 => 'Premium',default => __('main.Guest')} }}
                    </span>
                </div>
