              ...
              <tr>
                <td class="sm-px-6" style="border-radius: 4px; background-color: #fff; padding: 40px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                  ...
                  <p style="margin: 0; line-height: 24px">
                    {{ __('email.m24') }} <b><span style="color: #15803d">{{$para[0]}} ({{$para[1]}})</span></b> {{ __('email.m25') }} <b>{{$para[2]}}</b> {{ __('email.m26') }}.
                    <br>
                    <br>
                    {{ __('email.m27') }}.
                  </p>
                  ...
                  <div>
                    <a href="{{\App\Filament\Resources\CourseResource::getUrl()}}" style="display: inline-block; border-radius: 4px; background-color: #15803d; padding: 16px 24px; font-size: 16px; font-weight: 600; line-height: 1; color: #f8fafc; text-decoration: none">
                      <!--[if mso]>
